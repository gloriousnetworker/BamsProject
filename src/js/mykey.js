...
var x = setInterval(function () {
  ...
  if (distance < 0) {
    clearInterval(x);
    document.getElementById("days").innerHTML = 0o00;
    document.getElementById("hours").innerHTML = 0o00;
    document.getElementById("minutes").innerHTML = 0o00;
    document.getElementById("seconds").innerHTML = 0o00;
